...
final class RecursionExercicesTest extends FlatSpec with Matchers {
  ...
  "String compression function" should  "return expected result" in {
  ...
  "Filtered members repeated less than K times" should "return expected result for any type" in {
  ...
  "Super digits" should "return the expected results" in {
